...
public class PlaylistsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    artistSongs1.add(new Music(getString(R.string.artist3), getString(R.string.artist3music1)));

                    Intent goToTrack = new Intent(PlaylistsActivity.this, PlayingActivity.class);
                ...
                if (position == 1) {
                    ...
                    artistSongs2.add(new Music(getString(R.string.artist1), getString(R.string.artist1music1)));
                    artistSongs2.add(new Music(getString(R.string.artist2), getString(R.string.artist2music1_albumB)));
                    artistSongs2.add(new Music(getString(R.string.artist3), getString(R.string.artist3music2)));

...
public class ArtistsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    Intent goToTrack = new Intent(ArtistsActivity.this, PlayingActivity.class);
                ...
                if (position == 2) {
                    ...
                    artistSongs3.add(new Music(getString(R.string.artist3), getString(R.string.artist3music1)));
                    artistSongs3.add(new Music(getString(R.string.artist3), getString(R.string.artist3music2)));
                    artistSongs3.add(new Music(getString(R.string.artist3), getString(R.string.artist3music3)));
